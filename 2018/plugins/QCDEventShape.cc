...
//double recohtbins[nHLTmx+1] = {89, 118, 186, 259, 333, 403, 488, 528, 584, 688, 3000.0}; // 2018UL Trigger turn-on
//double genhtbins[ngenPT+1] = {89, 186, 333, 488, 584, 3000.0};   // 5 PT binning

double recohtbins[nHLTmx+1] = {92, 119, 185, 251, 319, 388, 467, 518, 579, 669, 3000.0};  // 2017UL Trigger turn-on
...
//double leadingPtThreshold[nHLTmx+1] ={89, 118, 186, 259, 333, 403, 488, 528, 584, 688, 3000.0}; //trigger turn on for 2017 UL JetHT sample
double leadingPtThreshold[nHLTmx+1] ={92, 119, 185, 251, 319, 388, 467, 518, 579, 669, 3000.0}; //trigger turn on for 2016 UL JetHT sample
