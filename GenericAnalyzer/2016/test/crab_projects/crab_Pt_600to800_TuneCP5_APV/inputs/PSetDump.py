...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/mc/RunIISummer20UL16MiniAODAPVv2/QCD_Pt-15to7000_TuneCP5_Flat2018_13TeV_pythia8/MINIAODSIM/106X_mcRun2_asymptotic_preVFP_v11-v1/120000/00B41AD6-70AC-3D47-807D-40F2D3744EC4.root')
)
...
process.analyzeBasicPat = cms.EDAnalyzer("MiniAODAnalyzer",
    BTagEffFile = cms.string('BTagEfficiency2016preVFP_09Jun2024.root'),
...
process.GlobalTag = cms.ESSource("PoolDBESSource",
    ...
    globaltag = cms.string('106X_mcRun2_asymptotic_preVFP_v11'),
