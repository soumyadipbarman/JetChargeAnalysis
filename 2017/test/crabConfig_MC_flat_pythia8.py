...
config.General.requestName ='JetCharge_TuneCP5_Flat_13TeV_pythia8_25Feb2023_v1'
...
config.Data.unitsPerJob = 20  # for Automatic must be 180-2700 range
...
config.Data.outputDatasetTag = 'JetCharge_MC_UL2017_Pythia8_flat_25Feb2023_v1'
